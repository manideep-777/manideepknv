...
export const metadata: Metadata = {
  title: "Kandepu Nage Venkata Manideep - Full stack web developer",
  authors: [{ name: "Kandepu Nage Venkata Manideep" }],
  description: "Portfolio website of Kandepu Nage Venkata Manideep - Full stack developer from the vijayawada, Andhra Pradesh, India",
  icons: "/logo.png",
  ...
  keywords: [
    ...
    "Freelancer Manideep",
    "Freelancer manideep vijayawada",
    "Manideep freelancer",
    "Manideep freelancing",
    "Freelance web developer in vijayawada andhra pradesh",
    "full stack freelance web developer",
    "full stack web developer in vijayawada andhra pradesh"
  ],
};
