...
const workData: WorkExperience = {
  ...
  logo: '/public/assets/DOA-whiteLogo.png',
  ...
  return (
    <section className="py-16 sm:py-20 w-full bg-black text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <motion.div variants={cardVariants} className="mb-10 sm:mb-12">
              ...
              <div className="relative bg-zinc-900 p-6 sm:p-8 rounded-2xl border border-zinc-800 hover:border-zinc-700 transition-all duration-300">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 sm:mb-8">
                  <div className="flex items-center mb-4 lg:mb-0">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-green-900 to-emerald-600 rounded-xl flex items-center justify-center mr-4 shadow-lg">
                      <Image src={DOALogo} alt="logo" className="object-contain" />
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-3xl font-bold text-white mb-1">{workData.company}</h3>
                      <p className="text-sm sm:text-xl text-green-400 font-semibold">{workData.role}</p>
                    </div>
                  </div>
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-gray-400 text-xs sm:text-sm">
                    <div className="flex items-center gap-1">
                      <Calendar className="w-4 h-4" />
                      <span>{workData.duration}</span>
                    </div>
                    <div className="flex items-center gap-1">
                  ...
                  {workData.achievements.map((achievement, index) => (
                    ...
                    >
                      <div className="text-green-400 font-bold text-base mb-1">
                        ...
                        {index === 1 && <Tractor className="w-5 h-5 mx-auto mb-1" />}
                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <ul className="space-y-3">
                    {workData.description.map((point, index) => (
                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                    {workData.screenshots.map((screenshot, index) => (
                      <motion.div
                        key={index}
                        variants={itemVariants}
        ...
        >
          <div className="relative group inline-block">
            ...
            <div className="relative bg-zinc-900 border border-zinc-800 rounded-xl p-6 sm:p-8">
